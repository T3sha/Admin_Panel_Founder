...
#lista rijeci
lista = ['admin/','administrator/', 'administration/','admin1/','wp-admin.php','admin2/','admin3/','admin4/','admin5/','moderator/','webadmin/','adminarea/','bb-admin/','adminLogin/','admin_area/','panel-administracion/',
'memberadmin/','administratorlogin/','adm/','account.asp','admin/account.asp','admin/index.asp','admin/login.asp','admin/admin.asp','/login.aspx','admin_area/admin.asp','admin_area/login.asp','admin/account.html','admin/index.html','admin/login.html','admin/admin.html',
...
'admin/index.brf','adm.brf','affiliate.brf','adm_auth.brf','memberadmin.brf','administratorlogin.brf','cpanel','cpanel.php','cpanel.html']

#pronalazak admin panela
try:
    for word in lista:
        urll = url+word
        r = requests.get(urll)
        rr = r.status_code
        if rr == 200:
            print(f"[FOUNDED] {urll}")
            break
        else:
            print("[FAILED] not funded")
